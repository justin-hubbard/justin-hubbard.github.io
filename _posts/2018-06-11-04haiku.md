...
- Need some services to make this run
	- ngrok for address to POST to
	- twilio for receiving texts and sending POST message
	- flask app to process the incoming message
