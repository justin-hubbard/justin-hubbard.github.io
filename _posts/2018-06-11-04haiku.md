...
![haiku](/assets/images/bathroom.png){: style="max-width: 30%;"}![haikuu](/assets/images/house.png){: style="max-width: 30%;"} ![haikuuu](/assets/images/awful.png){: style="max-width: 30%;"}
